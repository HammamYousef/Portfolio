      ...
      {items.map((item, idx) => (
        ...
        >
          ...
          <img
            ...
            height={100}
            width={100}
            src={`https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/${item.image}`}
            alt={item.name}
            className="relative h-14 w-14 object-contain transition duration-500 group-hover:z-30 group-hover:scale-105"
          />
        </div>
      ))}
    </>
